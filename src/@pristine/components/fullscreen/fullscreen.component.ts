...
import { FSDocument, FSDocumentElement } from '@pristine/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'pristine-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'pristineFullscreen'
})
export class PristineFullscreenComponent implements OnInit
{
