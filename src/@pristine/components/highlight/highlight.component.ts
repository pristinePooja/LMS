...
import { PristineHighlightService } from '@pristine/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[pristine-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'pristineHighlight'
})
export class PristineHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _pristineHighlightService: PristineHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._pristineHighlightService.highlight(this.code, this.lang));
