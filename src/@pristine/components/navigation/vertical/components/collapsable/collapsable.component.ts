...
@Component({
    selector       : 'pristine-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : pristineAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class PristineVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    {
        return {
            'pristine-vertical-navigation-item-collapsed': this.isCollapsed,
            'pristine-vertical-navigation-item-expanded' : this.isExpanded
        };
    }
    ...
    ngOnInit(): void
    {
        ...
        this._pristineVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._pristineVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._pristineVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._pristineVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: PristineNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: PristineNavigationItem, item: PristineNavigationItem): boolean
    {
