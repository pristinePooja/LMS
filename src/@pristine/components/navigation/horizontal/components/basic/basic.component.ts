...
@Component({
    selector       : 'pristine-horizontal-navigation-basic-item',
    templateUrl    : './basic.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class PristineHorizontalNavigationBasicItemComponent implements OnInit, OnDestroy
{
    ...
    )
    {
        ...
        this.isActiveMatchOptions = this._pristineUtilsService.subsetMatchOptions;
    }
    ...
    ngOnInit(): void
    {
        ...
        this.isActiveMatchOptions =
            this.item.isActiveMatchOptions ?? this.item.exactMatch
                ? this._pristineUtilsService.exactMatchOptions
                : this._pristineUtilsService.subsetMatchOptions;
