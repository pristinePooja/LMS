...
const slideInTop = trigger('slideInTop',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${PristineAnimationDurations.entering} ${PristineAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const slideOutTop = trigger('slideOutTop',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${PristineAnimationDurations.exiting} ${PristineAnimationCurves.acceleration}`
                }
            }
        )
    ]
