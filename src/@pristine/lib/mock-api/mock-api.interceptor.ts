...
import { PristineMockApiService } from '@pristine/lib/mock-api/mock-api.service';

@Injectable({
    providedIn: 'root'
})
export class PristineMockApiInterceptor implements HttpInterceptor
{
    /**
     * Constructor
     */
    constructor(
        @Inject(PRISTINE_MOCK_API_DEFAULT_DELAY) private _defaultDelay: number,
        private _fuseMockApiService: PristineMockApiService
    )
    {
    }
