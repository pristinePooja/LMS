...
import { PristineMockApiReplyCallback } from '@pristine/lib/mock-api/mock-api.types';

export class PristineMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: PristineMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: PristineMockApiReplyCallback): void
    {
        // Store the reply
