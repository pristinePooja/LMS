...
import { PristineNavigationItem, PristineNavigationService } from '@pristine/components/navigation';
...
export class SearchMockApi
{
     ...
     */
    constructor(
        private _pristineMockApiService: PristineMockApiService,
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._pristineNavigationService.getFlatNavigation(this._defaultNavigation);
