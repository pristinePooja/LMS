...
import { PristineMockApiService, PristineMockApiUtils } from '@pristine/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._pristineMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newList.id = PristineMockApiUtils.guid();
        ...
        this._pristineMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newCard.id = PristineMockApiUtils.guid();
        ...
        this._pristineMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newLabel.id = PristineMockApiUtils.guid();
